...
import { ReceiveD, LoadingEntities, AutoCompleteModel } from './mcs-save-receipt.interface';
...
@Component({
  selector: 'app-mcs-save-receipt-create',
  templateUrl: './mcs-save-receipt-create.component.html',
  styleUrls: ['./mcs-save-receipt-create.component.scss']
})
export class McsSaveReceiptCreateComponent implements OnInit {
