...
import { ReceiveD, LoadingEntities, AutoCompleteModel, ReceiveDetail } from './mcs-save-receipt.interface';
...
@Component({
  selector: 'app-mcs-save-receipt-detail',
  templateUrl: './mcs-save-receipt-detail.component.html',
  styleUrls: ['./mcs-save-receipt-detail.component.scss']
})
export class McsSaveReceiptDetailComponent implements OnInit {
