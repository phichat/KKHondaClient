...
import { LoadingEntities } from './mcs-save-po.interface';
...
@Component({
  selector: 'app-mcs-save-po-create',
  templateUrl: './mcs-save-po-create.component.html',
  styleUrls: ['./mcs-save-po-create.component.scss']
})
export class McsSavePoCreateComponent implements OnInit {
  ...
  constructor(
    ...
    private s_service: McsSavePoService,
