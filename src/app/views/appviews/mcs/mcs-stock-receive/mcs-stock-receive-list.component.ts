...
import { ReceiveH, ReceiveD, LoadingEntities } from './mcs-stock-receive.interface';
...
@Component({
  selector: 'app-mcs-stock-receive-list',
  templateUrl: './mcs-stock-receive-list.component.html',
  styleUrls: ['./mcs-stock-receive-list.component.scss']
})
export class McsStockReceiveListComponent implements OnInit {
