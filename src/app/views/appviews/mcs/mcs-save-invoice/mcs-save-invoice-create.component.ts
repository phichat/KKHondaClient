...
import { ReceiveD, LoadingEntities, AutoCompleteModel } from './mcs-save-invoice.interface';
...
@Component({
  selector: 'app-mcs-save-invoice-create',
  templateUrl: './mcs-save-invoice-create.component.html',
  styleUrls: ['./mcs-save-invoice-create.component.scss']
})
export class McsSaveInvoiceCreateComponent implements OnInit {
