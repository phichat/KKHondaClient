...
import { ReceiveD, LoadingEntities, AutoCompleteModel, ReceiveDetail } from './mcs-save-invoice.interface';
...
@Component({
  selector: 'app-mcs-save-invoice-detail',
  templateUrl: './mcs-save-invoice-detail.component.html',
  styleUrls: ['./mcs-save-invoice-detail.component.scss']
})
export class McsSaveInvoiceDetailComponent implements OnInit {
