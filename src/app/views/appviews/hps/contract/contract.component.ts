      ...
      this._activatedRoute.queryParams.subscribe(async p => {
         ...
         if (p.contractId) {
            this._contractService.getById(p.contractId).subscribe(res => {
                  ...
                  this.contractHireDropdown = [
                     {
                        ...
                        text: `${x.customerPrename}${x.customerName} ${x.customerSurname}`
                     }
                  ];
               });
               ...
               if (p.mode === 'create') {
                  this.contractModel.contractDate = (o.creditContract.contractDate == null ? new Date() : new Date(this.contractModel.contractDate));
