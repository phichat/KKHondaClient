...
import { ReceiveD, LoadingEntities, AutoCompleteModel } from './pss-return-product.interface';
...
@Component({
  selector: 'app-pss-return-product-edit',
  templateUrl: './pss-return-product-edit.component.html',
  styleUrls: ['./pss-return-product-edit.component.scss']
})
export class PssReturnProductEditComponent implements OnInit {
