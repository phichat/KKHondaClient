...
import { ReceiveD, LoadingEntities, AutoCompleteModel } from './pss-save-po.interface';
...
@Component({
  selector: 'app-pss-save-po-edit',
  templateUrl: './pss-save-po-edit.component.html',
  styleUrls: ['./pss-save-po-edit.component.scss']
})
export class PssSavePoEditComponent implements OnInit {
