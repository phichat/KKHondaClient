...
@Injectable()
export class CommissionEventService {
  ...
  GetFinanceNameAutoComplete(): Observable<DropDownModel[]> {
    return this.httpService.get(`${this.apiUrl}/GetFinanceNameAutoComplete`).pipe(map(x => x.json()))
  }
