...
@Component({
  selector: 'app-clear-money-edit',
  templateUrl: './clear-money-edit.component.html'
})
export class ClearMoneyEditComponent extends ClearMoneyConfig implements OnInit, OnDestroy {
