...
@Component({
  selector: 'app-contract-list-other-contract',
  templateUrl: './contract-list-other-contract.component.html'
})
export class ContractListOtherContractComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    await this.contractService.GetOtherContract().subscribe(o => {
